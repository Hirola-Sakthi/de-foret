...
import Data from "../../data/json/pages/tropical-villa.json";

export async function getStaticProps() {
  return { props: { data: Data } };
}
export default function TropicalVilla({ data }) {
  ...
  return (
    <>
      <div>
        <Head>
          <title>
            ECO Stay Tropical Villa - Best resort in havelock | De Foret Resort
          </title>
          <meta
            name="description"
            content="The resorts’s 14 De Tropical villas reflect the island’s natural, serene beauty. Every De Tropical Villa has a sense of discrete luxury, combining contemporary and exotic décor, with signature hand-crafted furniture, exotic fabrics, open-aired balcony and spectacular bathrooms. Book your perfect stay at DeForet - Contact: +91 800 124 6000"
          />
          <meta
            name="keywords"
            content="ECO Stay Tropical Villa, Book A Resort, Best resort in havelock, De Foret Resort, De Foret, De Foret Resorts, Havelock Island Resort, 5 star resort in andaman, andaman and nicobar best resort, andaman luxury resorts,"
          />
